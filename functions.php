...
function twentynineteen_scripts() {
	...
	wp_enqueue_script( 'twentynineteen-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix-min.js', array(), '20151215', true );

	// if ( has_nav_menu( 'menu-1' ) ) {
	// 	wp_enqueue_script( 'twentynineteen-priority-menu', get_theme_file_uri( '/js/priority-menu-min.js' ), array(), '1.0', true );
	// 	wp_enqueue_script( 'twentynineteen-touch-navigation', get_theme_file_uri( '/js/touch-keyboard-navigation-min.js' ), array(), '1.0', true );
	// }
	...
	if ( is_page('writing') ) {
		wp_enqueue_script( 'filter-category', get_theme_file_uri( '/js/filter-category-min.js' ), array(), '1.0', true );
	}
}
...
// Unhook contact-form-7 stylesheet - it is included in the sass files. 
